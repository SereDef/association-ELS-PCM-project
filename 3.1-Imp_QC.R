...
densityplot(imp_samp, ~ m_bmi_pregnancy ) 
densityplot(imp_samp, ~ m_dep_cont_pregnancy ) 
densityplot(imp_samp, ~ p_dep_cont_pregnancy ) 
densityplot(imp_samp, ~ m_bmi_5yrs ) 
densityplot(imp_samp, ~ m_dep_cont_3yrs ) 
densityplot(imp_samp, ~ p_dep_cont_3yrs ) 
densityplot(imp_samp, ~ ethnicity ) 
densityplot(imp_samp, ~ parity ) 
densityplot(imp_samp, ~ gest_age_birth ) 
densityplot(imp_samp, ~ gest_weight ) 
densityplot(imp_samp, ~ m_age_cont ) 
