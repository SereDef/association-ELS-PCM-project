...
ELS_PCM_essentials = ELS_PCM[, c('IDC', 
                ...
                'family_member_died','friend_relative_died', 'family_member_ill','admitted_to_hospital', 'health', 'unemployed', 'mother_work_study_problems', 'moved_house', 'blood_loss', 'examination', 'baby_worried', 'pregnancy_worried', 'obstetric_care', 'pregnancy_planned', 'victim_robbery', # LE
                "financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", "edu", # PS, without age, as the same variable is already in postnatal PR score
                "difficulties_contacts","difficulties_partner","difficulties_family_friend","mardich","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
...
test_essentials = subset(ELS_PCM_essentials[, 2:113], select=-c(le4, p_age))
...
meth['pre_life_events'] <- "~I( (family_member_died + friend_relative_died + family_member_ill + admitted_to_hospital + health + unemployed + mother_work_study_problems + moved_house + blood_loss + examination + baby_worried + pregnancy_worried + obstetric_care + pregnancy_planned + victim_robbery) / 15)" 
meth['pre_contextual_risk'] <- "~I( (financial_problems + financial_difficulties_pregnancy + income_reduced + housing_defects + housing_adequacy + housing_basic_living) / 6)"
meth['pre_personal_stress'] <- "~I( (m_age + gsi_mdich + forcemdich + publicordermdich + criminal_record_m + edu) / 6)"
meth['pre_interpersonal_stress'] <- "~I( (difficulties_contacts + difficulties_partner + difficulties_family_friend + mardich + divorce + family_support + family_acceptance + family_affection + family_acception + family_trust + family_painful_feelings + family_decisions + family_conflict + family_decisions_problems + family_plans + family_talk_sadness + family_talk_worries + famsize) / 18)"
meth['post_life_events'] <- "~I( (le1 + le2 + le3 + le4 + le5 + le6 + le7 + rep_grade + le17 + le23 + le24 + friend_moved + fire_burglary) / 13)"
meth['post_contextual_risk'] <- "~I( (tension_at_work + material_deprivation + financial_difficulties_childhood + le9 + trouble_pay + income_once + income_chronic + unemployed_once + unemployed_chronic) / 9)"
...
meth['post_interpersonal_risk'] <- "~I( (le11 + le12 + le13 + le14 + le16 + marital_problems + marital_status + family_size + m_fad_5yrs + m_fad_9yrs + p_fad_9yrs) / 11)"
meth['post_direct_victimization'] <- "~I( (le18 + le19 + le20 + le21 + le22 + m_harsh_parent + p_harsh_parent + bullying) / 8)"
...
predictormatrix[c('sex', 'age_child', 'm_bmi_berore_pregnancy', 'm_smoking', 'm_drinking',
                  'ethnicity', 'parity', 'gest_age_birth', 'gest_weight', 'm_bmi_pregnancy', 'm_bmi_5yrs',
                  'm_dep_cont_pregnancy', 'p_dep_cont_pregnancy', 'm_dep_cont_3yrs', 'p_dep_cont_3yrs', 'm_age_cont'),
                c('family_member_died','friend_relative_died', 'family_member_ill','admitted_to_hospital', 'health', 'unemployed', 'mother_work_study_problems','moved_house', 'blood_loss', 'examination', 'baby_worried', 'pregnancy_worried', 'obstetric_care', 'pregnancy_planned', 'victim_robbery', # LE
                  "financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                  "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", "edu", # PS
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","mardich","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
                  'le1','le2','le3','le4','le5','le6','le7','rep_grade','le17','le23','le24','friend_moved','fire_burglary', # LE
                  'tension_at_work','material_deprivation','financial_difficulties_childhood','le9','trouble_pay','income_once','income_chronic','unemployed_once','unemployed_chronic', # CR
                  'm_education','p_education','m_interpersonal_sensitivity','p_interpersonal_sensitivity','m_depression','p_depression','m_anxiety','p_anxiety','m_age','p_age', # PR
...
# So, let's adjust the predictormatrices such that ‘redundant’ items were not used as a predictor.
                                  ...
                                  ### PRENATAL ###
# LE domain 
predictormatrix[c('family_member_died','friend_relative_died','family_member_ill','admitted_to_hospital','health','unemployed','mother_work_study_problems','moved_house','blood_loss','examination','baby_worried','pregnancy_worried','obstetric_care','pregnancy_planned','victim_robbery'), # LE
                c("financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                  "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", "edu", # PS
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","mardich","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
                  'le1','le2','le3','le4','le5','le6','le7','rep_grade','le17','le23','le24','friend_moved','fire_burglary', # LE
                  'tension_at_work','material_deprivation','financial_difficulties_childhood','le9','trouble_pay','income_once','income_chronic','unemployed_once','unemployed_chronic', # CR
                  ...
                  'marital_problems','family_size','m_fad_5yrs','m_fad_9yrs','p_fad_9yrs','le11','le12','le13','le14','le16', # IR minus marital_status that is auxiliary for prenatal variables 
                  'm_harsh_parent','p_harsh_parent','bullying','le18','le19','le20','le21','le22', # DV
                  'pre_life_events',
                  'm_bmi_berore_pregnancy', 'm_bmi_pregnancy', 'm_dep_cont_pregnancy', 'p_dep_cont_pregnancy')] <- 0
# CR domain
predictormatrix[c("financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living"), # CR
                c('family_member_died','friend_relative_died','family_member_ill','admitted_to_hospital','health','unemployed','mother_work_study_problems','moved_house','blood_loss','examination','baby_worried','pregnancy_worried','obstetric_care','pregnancy_planned','victim_robbery', # LE
                  "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", "edu", # PS
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","mardich","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
                  'le1','le2','le3','le4','le5','le6','le7','rep_grade','le17','le23','le24','friend_moved','fire_burglary', # LE
...
# PS domain 
# I did not allow edu and dep here because of multicollinearity
predictormatrix[c("gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", "edu"), # PS
                c('family_member_died','friend_relative_died','family_member_ill','admitted_to_hospital','health','unemployed','mother_work_study_problems','moved_house','blood_loss','examination','baby_worried','pregnancy_worried','obstetric_care','pregnancy_planned','victim_robbery', # LE
                  "financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","mardich","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
                  'le1','le2','le3','le4','le5','le6','le7','rep_grade','le17','le23','le24','friend_moved','fire_burglary', # LE
...
predictormatrix[c("difficulties_contacts","difficulties_partner","difficulties_family_friend","mardich","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize"), # IS
                c('family_member_died','friend_relative_died','family_member_ill','admitted_to_hospital','health','unemployed','mother_work_study_problems','moved_house','blood_loss','examination','baby_worried','pregnancy_worried','obstetric_care','pregnancy_planned','victim_robbery', # LE
                  ...
                  'm_bmi_berore_pregnancy', 'm_bmi_pregnancy', 'm_dep_cont_pregnancy', 'p_dep_cont_pregnancy')] <- 0
                                  ...
                                  ### POSTNATAL ###
# LE domain 
predictormatrix[c('le1','le2','le3','le4','le5','le6','le7','rep_grade','le17','le23','le24','friend_moved','fire_burglary'), # LE
                c('family_member_died','friend_relative_died', 'family_member_ill','admitted_to_hospital', 'health', 'unemployed', 'mother_work_study_problems','moved_house', 'blood_loss', 'examination', 'baby_worried', 'pregnancy_worried', 'obstetric_care', 'pregnancy_planned', 'victim_robbery', # LE
                  "financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                  "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", # PS minus "edu" that is auxiliary for postnatal variables
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", 
                   # |-> IS minus "mardich" that is auxiliary for postnatal variables
                  'tension_at_work','material_deprivation','financial_difficulties_childhood','le9','trouble_pay','income_once','income_chronic','unemployed_once','unemployed_chronic', # CR
                  'm_education','p_education','m_interpersonal_sensitivity','p_interpersonal_sensitivity','m_depression','p_depression','m_anxiety','p_anxiety','m_age','p_age', # PR
                  'marital_problems','marital_status','family_size','m_fad_5yrs','m_fad_9yrs','p_fad_9yrs','le11','le12','le13','le14','le16', # IR
                  'm_harsh_parent','p_harsh_parent','bullying','le18','le19','le20','le21','le22', # DV
...
# CR domain
predictormatrix[c('tension_at_work','material_deprivation','financial_difficulties_childhood','le9','trouble_pay','income_once','income_chronic','unemployed_once','unemployed_chronic'), # CR
                c('family_member_died','friend_relative_died', 'family_member_ill','admitted_to_hospital', 'health', 'unemployed', 'mother_work_study_problems','moved_house', 'blood_loss', 'examination', 'baby_worried', 'pregnancy_worried', 'obstetric_care', 'pregnancy_planned', 'victim_robbery', # LE
                  "financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                  "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", # PS minus "edu" that is auxiliary for postnatal variables
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
...
# IP domain
predictormatrix[c('marital_problems','marital_status','family_size','m_fad_5yrs','m_fad_9yrs','p_fad_9yrs','le11','le12','le13','le14','le16'), # IR
                c('family_member_died','friend_relative_died', 'family_member_ill','admitted_to_hospital', 'health', 'unemployed', 'mother_work_study_problems','moved_house', 'blood_loss', 'examination', 'baby_worried', 'pregnancy_worried', 'obstetric_care', 'pregnancy_planned', 'victim_robbery', # LE
                  "financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                  "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", # PS minus "edu" that is auxiliary for postnatal variables
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
...
# DV domain
predictormatrix[c('m_harsh_parent','p_harsh_parent','bullying','le18','le19','le20','le21','le22'), # DV
                c('family_member_died','friend_relative_died', 'family_member_ill','admitted_to_hospital', 'health', 'unemployed', 'mother_work_study_problems','moved_house', 'blood_loss', 'examination', 'baby_worried', 'pregnancy_worried', 'obstetric_care', 'pregnancy_planned', 'victim_robbery', # LE
                  "financial_problems", "financial_difficulties_pregnancy", "income_reduced", "housing_defects", "housing_adequacy", "housing_basic_living", # CR
                  "gsi_mdich", "forcemdich", "publicordermdich", "criminal_record_m", # PS minus "edu" that is auxiliary for postnatal variables
                  "difficulties_contacts","difficulties_partner","difficulties_family_friend","divorce","family_support","family_acceptance","family_affection","family_acception","family_trust","family_painful_feelings","family_decisions","family_conflict","family_decisions_problems","family_plans","family_talk_sadness", "family_talk_worries", "famsize", # IS
