...
LE_postnatal <- cbind(LE_8M, LE_21M, LE_3Y, LE_4Y, LE_5Y, LE_6Y, # LE_8W
                      LE_child_18M, LE_child_30M, LE_child_3Y, LE_child_4Y, LE_child_5Y, LE_child_6Y)
...
# Merge all timepoints together 
PR_postnatal <- cbind(PR_8M, PR_21M, PR_3Y, PR_4Y, PR_5Y, PR_6Y) # PR_8W
...
# Merge all timepoints together 
IR_postnatal <- cbind(IR_8M, IR_21M, IR_3Y, IR_4Y, IR_5Y, IR_6Y, # IR_8W
                      Cha1, Cha2, Cha3)
...
# Merge all timepoints together 
DV_postnatal <- cbind(DV_18M, DV_30M, DV_3Y, DV_4Y, DV_5Y, DV_6Y)
